	...
	void *data)
{
	...
	case MSM_CAMERA_LED_OFF:
		flash_set_state(MSM_CAMERA_LED_OFF);
		break;

	case MSM_CAMERA_LED_LOW:
		flash_set_state(MSM_CAMERA_LED_LOW);
		break;

	case MSM_CAMERA_LED_HIGH:
		flash_set_state(MSM_CAMERA_LED_HIGH);
		break;

	case MSM_CAMERA_LED_INIT:
		flash_set_state(MSM_CAMERA_LED_INIT);
		break;
	...
	case MSM_CAMERA_LED_RELEASE:
		...
		flash_set_state(MSM_CAMERA_LED_RELEASE);
		break;
	...
	case MSM_CAMERA_TORCH_ON:
		if (acer_board_id <= HW_ID_DVT3) {
			...
			flash_set_state(MSM_CAMERA_TORCH_ON);
		break;
	case MSM_CAMERA_TORCH_OFF:
		if (acer_board_id <= HW_ID_DVT3) {
			...
			flash_set_state(MSM_CAMERA_TORCH_OFF);
		break;
	default:
		rc = -EFAULT;
		break;
