...
static struct attribute *imx135_attrs[] = {
        &sensor_id_attribute.attr,
        &vendor_attribute.attr,
        NULL,  // need to NULL terminate the list of attributes
};

static struct attribute_group imx135_attr_group = {
        .attrs = imx135_attrs,
};

static struct sensor_info_t imx135_sensor_info = {
        .kobj_name = "dev-info_back-camera",
        .attr_group = &imx135_attr_group,
};
...
static struct msm_sensor_ctrl_t imx135_s_ctrl = {
	...
	.sensor_info = &imx135_sensor_info,
};
