...
#define WCD9320_DRIVER_NAME	"wcd9320"

#define WCD9320_IOCTL_MAGIC		'f'
#define IOC_MAXNR				2

#define WCD9320_SET_CODEC		_IO(WCD9320_IOCTL_MAGIC, 1)
#define WCD9320_GET_CODEC		_IO(WCD9320_IOCTL_MAGIC, 2)

struct wcd9320_codec_info {
	uint32_t reg;
	uint32_t val;
};
